...
export const DEEP_TOPICS: DeepTopic[] = [
  {
    ...
    normalFindings: [
      ...
      "Capillary refill under 3 seconds; peripheral pulses 2+ and symmetrical; no peripheral oedema.",
    ...
    nursingNotes: [
      ...
      "After cardiac catheterization: keep the limb straight, check the puncture site AND distal pulses/warmth/colour; numbness or a cool pale limb distal to the site = circulation problem = notify immediately. Push fluids to flush the dye; watch urine output (dye is nephrotoxic).",
    ...
    redFlags: [
      ...
      "Sudden dyspnea with frothy pink sputum and crackles — acute pulmonary oedema: sit upright, legs dependent, oxygen, call for orders (diuretic, morphine).",
  ...
  },
  {
    ...
    nursingNotes: [
      ...
      "TB care: airborne precautions (N95, negative-pressure room), sputum specimens in the early morning, therapy runs months — the biggest threat is non-adherence. Rifampin turns urine/tears orange (harmless); isoniazid needs B6 and no alcohol (neuropathy and hepatitis); ethambutol threatens colour vision.",
    ...
    redFlags: [
      ...
      "Frothy pink sputum = pulmonary oedema, not a lung infection.",
  ...
  },
  {
    ...
    overview:
      "The GI tract is a muscular tube running mouth to anus, with the liver, gallbladder, and pancreas as its chemical support crew. Digestion is mechanical (chewing, churning, peristalsis) and chemical (acid, enzymes, bile). The stomach's acid bath begins protein digestion and kills microbes; the small intestine — duodenum, jejunum, ileum — does nearly all nutrient absorption; the colon reclaims water and forms stool. Anything that speeds transit (diarrhoea) steals water and electrolytes; anything that slows it (opioids, immobility, low fibre) produces constipation.\n\nThe liver is the body's chemical factory: it makes albumin (oncotic pressure — low albumin means oedema), clotting factors (liver failure means bleeding), detoxifies drugs and ammonia, stores glycogen, and produces bile. When it fails, the failures map to those jobs: ascites and oedema (albumin), bruising and haemorrhage (clotting), encephalopathy (ammonia), jaundice (bilirubin). Portal hypertension backs blood into fragile oesophageal varices — the GI bleed that kills fastest.\n\nPeptic ulcer disease is usually an infection (H. pylori) or an injury (NSAIDs) to the mucosal defence. Gastric ulcer pain classically worsens WITH food; duodenal ulcer pain arrives 2–4 hours AFTER meals and at night, relieved by eating. The complications to watch: bleeding (melena — black tarry stools; coffee-ground emesis), perforation (sudden rigid 'board-like' abdomen — emergency), and obstruction.",
    keyStructures: [
      "Route: mouth → oesophagus → stomach → duodenum → jejunum → ileum → cecum → colon → rectum. The lower oesophageal sphincter failing = reflux (GERD); the pyloric sphincter controls stomach emptying.",
    ...
    nursingNotes: [
      ...
      "GI bleed action: black tarry stools or coffee-ground emesis with abdominal pain gets the medical officer called first; anticipate IV access, labs (Hb, type & cross), NPO. Prokinetics (metoclopramide) are CONTRAINDICATED in active bleeding — never stimulate a bleeding gut.",
      ...
      "Low-residue diet after bowel surgery/flares: white rice and bread, tender baked meats, no whole grains, raw vegetables, or seeds. High-fibre for constipation and diverticulOSIS; seeds and nuts are the caution in diverticular disease.",
    ],
    redFlags: [
      ...
      "Hematemesis in a known cirrhotic — think ruptured oesophageal varices: massive-bleed protocol.",
  ...
  },
  {
    ...
    nursingNotes: [
      ...
      "Hyperkalemia in renal failure: peaked T waves, weakness, arrhythmias. Emergency ladder: calcium gluconate protects the heart, insulin+glucose shifts K into cells, kayexalate/dialysis removes it. Chronic defence: low-potassium diet (limit oranges, bananas, tomatoes) and never IV potassium by push, anywhere, ever.",
    ...
    redFlags: [
      ...
      "Periorbital oedema and tea-colored urine 1–3 weeks after a strep skin/throat infection (post-streptococcal glomerulonephritis, especially in children).",
    ],
  ...
  },
  {
    ...
    nursingNotes: [
      ...
      "Meningitis: droplet isolation until 24 h of effective antibiotics; dark quiet room (seizure and stimulation control); fluids often restricted for cerebral oedema; nuchal rigidity, Kernig's and Brudzinski's signs; petechial rash + fever = act immediately.",
    ...
    redFlags: [
      ...
      "Sudden worst-ever headache (possible subarachnoid haemorrhage); new headache with fever and stiff neck (meningitis).",
  ...
  },
  {
    ...
    nursingNotes: [
      "Neurovascular checks distal to every cast, splint, and traction: colour, warmth, capillary refill, pulses, sensation, movement — on a schedule, and always against the opposite limb. Pain unrelieved by prescribed analgesia is the alarm: assess, loosen, notify — never just re-medicate.",
      ...
      "Osteoporosis prescription: weight-bearing exercise is the bone-builder; calcium and vitamin D supply the materials; fall-proof the home. Bisphosphonates: take on an empty stomach with a full glass of water and stay UPRIGHT 30 minutes (oesophageal erosion).",
  ...
  },
  {
    ...
    keyStructures: [
      ...
      "Burn depth in nursing terms: superficial (epidermis — red, painful, no blister: sunburn), partial-thickness (into dermis — blistered, weeping, VERY painful), full-thickness (all layers — white/charred/leathery and PAINLESS in the centre because nerve endings are gone; edges still hurt).",
    ...
    nursingNotes: [
      ...
      "Wound cultures BEFORE the first antibiotic dose; cleanse from clean to dirty, centre outward, one stroke per gauze.",
  ...
  },
  {
    ...
    keyStructures: [
      ...
      "Normal counts to anchor: Hb ~12–16 (women)/14–18 (men) g/dL; WBC 5,000–10,000/mm³; platelets 150,000–400,000/mm³. Hematocrit ≈ 3 × haemoglobin.",
      "Iron-deficiency anaemia (microcytic): iron with vitamin C/orange juice (never with coffee/tea/milk — absorption blockers), dark stools are expected, liquid iron through a straw (teeth staining). Paediatric prevention: iron-fortified foods; excess cow's milk crowds out iron.",
      "B12 deficiency (pernicious anaemia): add NEUROLOGIC signs — paresthesia, balance trouble; lifelong B12 injections when intrinsic factor is missing.",
    ...
    nursingNotes: [
      "Neutropenic precautions: private room, strict hand hygiene, no fresh flowers/standing water, no raw fruits/vegetables per policy, screen every visitor and staff member for illness (a staff member with diarrhoea or a child's chickenpox exposure is reassigned — the nursery/immunocompromised rule), daily site inspections of every line and orifice, and treat ANY fever as an emergency culture-and-antibiotics event.",
      ...
      "Anaemia nursing reads compensations: pulse and respirations up, pallor, fatigue — pace activities, prioritize oxygenation, and investigate the cause (iron? B12? bleeding? chronic disease?). A cancer client's rising pulse with Hb 9 is expected physiology to monitor, not a mystery.",
  ...
  },
  {
    ...
    keyStructures: [
      ...
      "Amniotic fluid cushions, allows movement and symmetrical growth, stabilizes temperature — 'dry labour' is a myth to dispel; membranes are often ruptured deliberately to help labour. After ANY rupture: check FHR and for cord prolapse FIRST.",
      ...
      "Cervical language of labour: dilation (0–10 cm), effacement (%), station (presenting part vs ischial spines; + numbers = descending).",
      "Foetal positioning: vertex is business as usual; breech and transverse change the delivery plan; a multipara at 8 cm with vertex at +2 delivers SOON — bedside now.",
    ...
    normalFindings: [
      ...
      "Foetal heart rate 110–160 bpm with moderate variability and accelerations; foetal movement felt daily (kick counts are the home foetal-wellbeing monitor; movement typically DECREASES near labour onset — increase is not a labour sign).",
    ...
    nursingNotes: [
      ...
      "Supine hypotension (vena-caval syndrome): a term uterus on the vena cava crashes the BP — LEFT lateral position is both prevention and the first treatment for maternal hypotension and most foetal distress pictures.",
      "Preeclampsia/PIH watchlist: rising BP, proteinuria, headache, visual changes, epigastric pain, sudden oedema/weight gain. Admission priority = baseline vitals (everything after is measured against them). Magnesium sulfate safety trio EVERY check: respirations > 12, reflexes present, urine > 30 mL/h — falling urine output is the toxicity gateway (renally excreted); hypertonic reflexes suggest the level is LOW, not high; calcium gluconate is the antidote.",
      "Oxytocin laws: always piggybacked, always on a pump; sustained contraction > 90 s or foetal distress = STOP the infusion entirely (reducing the rate still feeds the problem), then left side, oxygen, notify.",
      ...
      "Postpartum haemorrhage chain: check FLOW → FUNDUS (massage if boggy) → BLADDER (a full bladder displaces the uterus up and sideways and blocks contraction) → vitals → escalate. Diuresis and 200 mL/2 h outputs after diuretics/delivery get REPORTED forward — trends continue across shifts.",
      ...
      "Foetal monitoring responses table: early decels = document; variables = reposition, check cord; lates or bradycardia = left side + O2 + IV + stop oxytocin + notify — in that spirit and nearly that order.",
      "NST vs CST: nonstress test watches accelerations with movement (no drugs involved — 'stop the Pitocin' is a trap; ANY decelerations in an NST go to the medical officer); contraction stress test uses stimulation.",
      "Emergency birth priorities: support the head, check for nuchal cord once the head is out, dry and warm the baby on the mother's chest, no cord traction; haemorrhage watch while awaiting transport.",
    ],
    redFlags: [
      ...
      "Painless bright-red bleeding late in pregnancy = previa (no vaginal exams!); painful rigid abdomen with dark bleeding = abruption. COMPLETE previa at term in labour = cesarean, full stop.",
      ...
      "Boggy fundus with heavy flow; saturated pad in minutes; clots larger than expected — postpartum haemorrhage in motion.",
  ...
  },
  {
    ...
    keyStructures: [
      ...
      "Prioritisation stack in one breath: ABC → Maslow (physiological before safety before psychosocial) → acute over chronic → unstable over stable → assess before implement (with the emergency exceptions).",
    ],
    normalFindings: [
      "A complete database: history, medications (ASK ABOUT HERBALS — appetite-suppressant supplements before surgery are a notify-the-medical officer find), allergies (the FIRST question before any dye study or new antibiotic), baselines, psychosocial and support systems (who appears in the client's worries, and as comfort or threat?).",
    ...
    nursingNotes: [
      ...
      "Action-first exemplars (the exceptions): seizure → protect; torticollis/oculogyric crisis on antipsychotics → PRN anticholinergic NOW; NMS (105 °F + rigidity) → HOLD the drug and call STAT; visible bowel → moist sterile cover; FHR 60 → position/O2/IV; haemorrhage → pressure and escalation.",
      "Delegation drills: the enrolled nurse takes the stable dressing change and the routine medications; the registered nurse keeps the blood transfusion, the pre-op teaching, the hospice transition, the new-pain assessment; the assistant takes hygiene, ambulation-with-walker, urinals, feeding (never medications — in ANY setting, including home care).",
      "Question-the-order muscle: propranolol in wheezing COPD; lidocaine in complete heart block (it silences the escape rhythm that's keeping the client alive); prokinetics in GI bleeding; live vaccine in an immunosuppressed infant; KVO fluids in sickle crisis; analgesia at 9 cm dilation (notify with the labour status, don't silently hold); DTP after a 40 °C fever (ask about DT without pertussis).",
      "Communication is implementation: reflect feelings, open-ended beats yes/no, no 'why' interrogations, no false reassurance, no buck-passing to social workers/physicians before you've listened; name inappropriate behaviour + state the expected change; with delusions — validate the FEELING, present reality, never explore the content; with escalating anger — help identify and express the feelings before any seclusion conversation.",
      "Teaching evaluation = behaviour, not attendance: the celiac family names the BROW grains; the T-tube client cancels the swimming laps; the colostomy client stops irrigating after every meal; the MAOI client cancels the pepperoni-and-wine celebration. 'Further teaching needed' questions hide ONE wrong behaviour among three correct ones — find the rule it breaks.",
      ...
      "Incident response: assess the client, notify the medical officer, file the report — never silent-fix the schedule; suspected impaired colleague = report objective, verifiable observations up the line.",
    ...
    redFlags: [
      ...
      "Delegating assessment, teaching, or an unstable client downward — or letting 15 years of enrolled nurse experience take the transfusion.",
    ...
    commonConditions: ["Prioritisation", "Delegation", "Documentation", "Medication safety", "Informed consent", "Client rights", "Therapeutic communication", "Teaching & evaluation", "Incident reporting"],
  },
];
