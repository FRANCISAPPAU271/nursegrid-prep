...
import StudyAccessGate from "@/components/dashboard/StudyAccessGate";
    ...
    <>
      ...
      <div className="flex min-h-screen bg-slate-50">
        ...
        <main className="min-w-0 flex-1">
          <div className="mx-auto max-w-6xl px-4 py-6 pb-24 sm:px-6 md:pb-6 lg:px-8 lg:py-8">
            <StudyAccessGate hasAccess={hasStudyAccess(user)}>{children}</StudyAccessGate>
          </div>
        </main>
      </div>
      <MobileTabBar />
