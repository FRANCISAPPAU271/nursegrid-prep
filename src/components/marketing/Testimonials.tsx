const TESTIMONIALS = [
  ...
  {
    quote:
      "The strategy library taught me to think through prioritisation instead of guessing. And honestly? GH₵ 200 for a full year when foreign apps wanted 10 times that — paid with MoMo in 2 minutes. No contest.",
    name: "Efua M.",
