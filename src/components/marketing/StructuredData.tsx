  ...
  const data = {
    ...
    "@graph": [
      ...
      },
      {
        ...
        name: "NurseGrid Prep",
        description:
          "Built for Ghana's student nurses & midwives: organise clinicals and revision, then master 3,800+ unique NMC licensing exam-style questions with rationales and proven test-taking strategies.",
