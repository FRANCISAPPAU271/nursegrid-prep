...
const FAQS = [
  ...
  },
  {
    ...
    a: "Choose the plan that fits you: $5 for 4 months, $9 for 8 months, or $13 for a full year (best value). All plans unlock unlimited access to all 6,600+ unique questions, rationales, strategies, and progress tracking for the length of the plan.",
  },
  {
